      ...
      <div class="grid md:grid-cols-2">
        <div class="flex flex-col md:flex-row md:space-x-12 items-center">
          <div class="flex justify-center items-center mb-10 md:mb-0">
            ...
            <h1 href="/" class="text-sm font-semibold text-white ml-2">G.KMETALWORKS</h1>
          </div>
          <ul
        ...
        <div class="md:place-self-end place-self-center mt-10 md:mt-0">
          <ul class="flex space-x-8 items-center">
            <a href="https://www.instagram.com/g.kmetalworks?igsh=OTdtemlnd2kyMzA1">
              <li>
                <svg
            ...
            <a href="https://www.facebook.com/share/rAxn2756jmUjJfwP/">
              <li>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="26"
            ...
            <a href="https://www.whatsapp.com/">
              <li>
                <svg
                  ...
                  height="26"
                  fill="currentColor"
                  class="bi bi-whatsapp text-white hover:text-theme-secondary transition duration-200 cursor-pointer"
                  viewBox="0 0 16 16"
                >
                  <path
            ...
            <a href="https://mail.google.com/mail/u/0/">
              <li>
                <svg
                  ...
                  height="26"
                  fill="currentColor"
                  class="bi bi-envelope text-white hover:text-theme-secondary transition duration-200 cursor-pointer"
                  viewBox="0 0 16 16"
                >
                  <path
